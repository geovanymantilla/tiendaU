...
<section id="team" class="pb-5">
  <div class="container">
  <h5 class="section-title h1">SERVICIOS DE <c:out value="${s.tiedaBean.getNombre()}" /></h5>
  ...
  <div class="row">
    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
      <div class="card h-100">
        ...
        <div class="card-body">
          <h4 class="card-title">
            <a href="#">Service<c:out value="${s.id}" /></a>
          </h4>
          <p class="card-text"><c:out value="${s.descripcion}" /></p>
        </div>
      </div>
    </div>
</c:forEach>
